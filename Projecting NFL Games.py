...
# 
# Accuracy: 0.6608357628765792
# 
# Precision: 0.6671406411582212
# 
# Recall: 0.9596504276682781
# 
# ##### F Score: 0.7870977581210918
# 
# 
...
#make sure to run the regression with the correctly balanced/trained data (clf)
        predictionbin = clf_bal.predict([[input_spread,input_OL, var3.get(),var4.get(),var5.get()]])
        if predictionbin == 1:
